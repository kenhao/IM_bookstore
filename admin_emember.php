...
<head>
    ...
    <script src="js/datatable_emember.js"></script>
    <style>
        body {
    font-family: "微軟正黑體";
}
            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="admin_emember.php">會員</a></li>
        ...
        <div class="col-md-8 text-center">
            <form class="form-horizontal form-inline" name="form1" id="form1" method="post">
                ...
                <table id="edit" class="table table-striped table-bordered">
                    <thead>
                        <tr>
                            <th class="text-center">會員帳號mId</th>
                            <th class="text-center">會員姓名name</th>
                            <th class="text-center">會員生日birthday</th>
                            <th class="text-center">會員信箱email</th>
                            <th class="text-center">會員密碼pwd</th>

...
<head>
    ...
    <script src="js/datatable_emessage.js"></script>
    <style>
        body {
    font-family: "微軟正黑體";
}
            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="admin_emessage.php">留言</a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-8 text-center">
            <form class="form-horizontal form-inline" name="form1" id="form1" method="post">
                ...
                <table id="edit" class="table table-striped table-bordered">
                    <thead>
                        <tr>
                            <th class="text-center">留言者message_name</th>
                            <th class="text-center">留言主題message_subject</th>
                            <th class="text-center">留言內容message_content</th>
                            <th class="text-center">留言編號message_Id</th>
                            <th class="text-center">存檔/取消</th>
                        </tr>
                        <tr>
                            <td class="text-center">
                                <input type="text" id="message_name" name="message_name">
                            </td>
                            <td class="text-center">

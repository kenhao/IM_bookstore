...
<head>
    ...
    <script src="js/datatable_eproduct.js"></script>
    <style>
        body {
    font-family: "微軟正黑體";
}
            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="admin_eproduct.php">商品</a></li>
    ...
    <frame>
        <div class="row">
            ...
            <div class="col-md-8 text-center">
                <form class="" name="form1" id="form1" method="post" target="_show">
                    ...
                    <table id="edit" class="table table-striped table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">商品名稱pName</th>
                                <th class="text-center">單價unitPrice</th>
                                <th class="text-center">售價salePrice</th>
                                <th class="text-center">分類category</th>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th class="text-center">商品介紹product_description</th>
                                <th class="text-center">作者介紹author_description</th>
                                <th class="text-center">商品圖片picture</th>
                                <th class="text-center">作者author</th>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <input type="text" id="author_description" name="author_description">
                                </td>
                                <td class="text-center">
                    ...
                    <table id="example" class="" width="100%" border="1" style="border-color: #C6D2C6">
                        <thead>
                            <tr>
                                <th class="text-center">商品編號pNo</th>
                                <th class="text-center">商品名稱pName</th>
